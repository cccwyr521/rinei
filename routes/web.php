...
//忘记密码
Route::get('admin/forget/pwd','Admin\LoginController@forget');
    //发送邮件
...
//重置密码
Route::post('admin/reset/pwd/save','admin\LoginController@save');
...
Route::middleware(['admin_auth','permission_auth'])->prefix('admin')->group(function(){
   ...
   /*#############################[权限相关]#############################*/
    ...
    //修改密码页面
    Route::get('user/pwd','Admin\AdminUsersController@pwd')->name('admin.user.pwd');
    //执行修改密码
    Route::post('user/pwd/save','Admin\AdminUsersController@updatePwd')->name('admin.user.pwd.save');
     /*#############################[用户相关]#############################*/
     /*#############################[角色相关]#############################*/
     //角色列表
     ...
     Route::get('goods/sku/edit/{goods_id}','Admin\GoodsSkuController@edit')->name('admin.goods.sku.edit');
      //商品添加操作
     Route::post('goods/sku/save','Admin\GoodsSkuControll er@doEdit')->name('admin.goods.sku.save');
     //商品sku属性列表接口
    ...
    /*#############################[地区管理]#############################*/
      ...
      //执行发送红包
      Route::post('bonus/doSend','Admin\BonusController@doSend')->name('admin.bonus.doSend');
